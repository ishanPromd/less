...
const CustomLoader: React.FC = () => (
  <div className="min-h-screen bg-white flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-gray-600">Loading Available Lessons...</p>
      <style jsx>{`
        .loader {
          width: fit-content;
          font-size: 40px;
      ...
      <div className="w-full px-4 py-6 pb-24">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              {currentView === 'subjects' && (
                <h2 className="text-xl font-bold text-gray-900">Premium Learning Library</h2>
              )}
              {currentView === 'lessons' && selectedSubject && (
                <div>
                  <h2 className="text-xl font-bold text-gray-900">{selectedSubject.name} Premium Content</h2>
